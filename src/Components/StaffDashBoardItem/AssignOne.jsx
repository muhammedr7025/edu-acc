...
function AssignOne() {
  ...
  const handlePdfClick = (pdfFileName) => {
    const supabaseBaseUrl = 'https://jubfonzpooabcktpgfip.supabase.co/storage/v1/object/public/AssignOne/pdfs/';
  ...
  return (
    <div className="w-full p-[2.5rem] bg-gray-100 rounded-lg shadow-lg  overflow-y-scroll"> 
      <div className="text-2xl pb-4 font-medium">Assignment 1 Question Paper</div>
          ...
          <ul className="flex flex-col ">
            {pdfFiles.map((file, index) => (
              ...
              >
                ...
                <a
                  href={`https://jubfonzpooabcktpgfip.supabase.co/storage/v1/object/public/AssignOne/pdfs/${selectedStaff}/${selectedSubject}/${file.name}?t=${file.last_modified}`}
                  download
