...
function SeriesOne() {
  ...
  const handlePdfClick = (pdfFileName) => {
    const supabaseBaseUrl = 'https://jubfonzpooabcktpgfip.supabase.co/storage/v1/object/public/SeriesOne/pdfs/';
          ...
          <ul className="flex flex-col ">
            {pdfFiles.map((file, index) => (
              ...
              >
                ...
                <a
                  href={`https://jubfonzpooabcktpgfip.supabase.co/storage/v1/object/public/SeriesOne/pdfs/${selectedStaff}/${selectedSubject}/${file.name}?t=${file.last_modified}`}
                  download
